# pretestTaskMLX
1. Built and installed C++ API from source following the [MLX](https://ml-explore.github.io/mlx/build/html/install.html) documentation. Also installed the mlx binaries from PyPI using ```pip install mlx```</br></br>
...
2. Speech recogntion using whisper in MLX (Python). </br></br>
